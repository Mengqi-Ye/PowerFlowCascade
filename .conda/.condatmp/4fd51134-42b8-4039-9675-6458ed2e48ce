...
# installed.
TCL_PREFIX='x:/mye500/projects/Map2Grid/.conda\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='x:/mye500/projects/Map2Grid/.conda\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='x:/mye500/projects/Map2Grid/.conda\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-Ix:/mye500/projects/Map2Grid/.conda\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-Lx:/mye500/projects/Map2Grid/.conda\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='x:/mye500/projects/Map2Grid/.conda\Library\lib\tclstub86.lib'
